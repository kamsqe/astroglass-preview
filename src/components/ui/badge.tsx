...
const badgeVariants = cva(
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default: 'border-transparent bg-primary text-base-content shadow hover:bg-primary/80',
        secondary: 'border-transparent bg-secondary text-base-content hover:bg-secondary/80',
        ...
        moderateDecrease:
          'border-transparent bg-red-500/15 text-red-600 dark:text-red-400 hover:bg-red-500/25',
        unchanged:
          'border-transparent bg-orange-500/15 text-orange-600 dark:text-orange-400 hover:bg-orange-500/25',
      },
    },
    defaultVariants: {
      variant: 'default',
