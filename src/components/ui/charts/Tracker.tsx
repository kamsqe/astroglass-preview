...
const Tracker = ({ data, className }: TrackerProps) => {
  return (
      ...
      {data.map((item, index) => (
        <div
          ...
          className={cn(
            ...
            item.color === 'emerald'
              ? 'bg-emerald-500/50 hover:bg-emerald-400 shadow-[0_0_5px_rgba(16,185,129,0.3)]'
              : item.color === 'yellow'
                ? 'bg-yellow-500/50 hover:bg-yellow-400'
                : item.color === 'red'
