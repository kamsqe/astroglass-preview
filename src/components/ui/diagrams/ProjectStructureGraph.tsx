...
const Flow = () => {
  ...
  return (
    <div className="h-[500px] w-full min-h-[500px] rounded-2xl border border-[hsl(var(--bc)/0.1)] bg-[hsl(var(--b1)/0.5)] shadow-2xl overflow-hidden backdrop-blur-md relative">
      <ReactFlow
        nodes={nodes}
        edges={edges}
