...
<div className="my-10 not-prose overflow-x-auto pb-4">
  <div className="min-w-[700px] md:min-w-0 rounded-2xl border border-[hsl(var(--bc)/0.1)] bg-[hsl(var(--b1)/0.5)] backdrop-blur-xl p-8 shadow-2xl ring-1 ring-[hsl(var(--bc)/0.05)]">
