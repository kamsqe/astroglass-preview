...
<CardGrid>
  <LinkCard
    ...
    href="/docs/components/sections/hero"
  />
  <LinkCard
    title="About"
    description="Company or product introduction sections."
    href="/docs/components/sections/about"
  />
  <LinkCard
    title="Features"
  ...
  <LinkCard
    ...
    href="/docs/components/sections/portfolio"
  />
  <LinkCard
    title="Pricing"
