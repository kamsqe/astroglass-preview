...
pages/
├── portfolio/
│   ├── PortfolioPageLiquid.astro
│   ├── PortfolioPageGlass.astro
│   └── ...
```
...
File-based routing. The `[theme].astro` dynamic route generates pages for each enabled theme. The `[lang]` directory patterns handle localized page variants.
