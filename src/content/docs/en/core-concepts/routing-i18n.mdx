...
- src/
  - pages/
    ...
    - **[theme]/portfolio.astro** — Dynamic portfolio pages (e.g., /liquid/portfolio)
    ...
    - ru/                  — Russian Localization
      ...
      - 404.astro          — /ru/404 Error page
      - about.astro        — /ru/about
      - privacy.astro      — Russian Privacy Policy
      - terms.astro        — Russian Terms of Service
</FileTree>
