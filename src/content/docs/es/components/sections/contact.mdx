...
<Callout type="info" title="Sin Propiedades (Props)">
  Los componentes Contact no reciben propiedades externas. Para editar las etiquetas del formulario
  o los mensajes de validación, actualiza `src/locales/{lang}/contact.json`.
</Callout>
