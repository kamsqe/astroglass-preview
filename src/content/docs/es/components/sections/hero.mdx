...
<Callout type="info" title="Sin Propiedades (Props)">
  Los componentes Hero no reciben propiedades externas. Para cambiar el titular, subtitular o texto
  del CTA, edita `src/locales/es/hero.json` (o el archivo de idioma correspondiente).
</Callout>
