...
<Callout type="info" title="Sin propiedades externas">
  Los componentes de encabezado no aceptan propiedades (props) externas. Los elementos de navegación
  se definen en los archivos de configuración y las etiquetas se cargan desde el JSON de idioma.
</Callout>
