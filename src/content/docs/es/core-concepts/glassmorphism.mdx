...
<Callout type="tip" title="Personalizando Efectos de Vidrio">
  La intensidad del desenfoque, la opacidad y los efectos de borde se pueden ajustar por tema a
  través de las variables CSS en `src/styles/_themes.css`. Busque `--glass-blur`, `--glass-opacity`,
  y propiedades personalizadas relacionadas.
</Callout>
