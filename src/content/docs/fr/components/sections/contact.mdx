...
<Callout type="info" title="Pas de de Propriétés (Props)">
  Les composants Contact ne prennent aucune propriété externe. Pour modifier les libellés du
  formulaire ou les messages de validation, mettez à jour `src/locales/{lang}/contact.json`.
</Callout>
