...
<Callout type="info" title="Pas de Propriétés (Props)">
  Les composants Hero ne prennent aucune propriété externe. Pour modifier le titre d'accroche, le
  sous-titre ou le texte du CTA, modifiez `src/locales/fr/hero.json` (ou le fichier de langue
  approprié).
</Callout>
