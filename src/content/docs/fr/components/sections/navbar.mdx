...
<Callout type="info" title="Pas de props">
  Les composants d'en-tête n'acceptent aucune prop externe. Les éléments de navigation sont définis
  dans les fichiers de configuration et les étiquettes sont chargées à partir des fichiers JSON
  locaux.
</Callout>
