...
- src/
  - pages/
    ...
    - **[theme]/portfolio.astro** — Страницы портфолио (/liquid/portfolio)
    ...
    - ru/
      ...
      - 404.astro — Страница ошибки 404 (русский)
      - privacy.astro — Политика конфиденциальности (русский)
      - terms.astro — Условия использования (русский)
</FileTree>
