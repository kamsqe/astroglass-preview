...
<Callout type="info" title="Нужна помощь?">
  Ознакомьтесь с [руководством по формам и валидации](/docs/en/guides/forms-and-validation) или [создайте тикет](https://github.com/kamsqe/astroglass/issues), если у вас возникли проблемы.
</Callout>
