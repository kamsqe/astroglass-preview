...
<Callout type="info" title="Нужна помощь?">
  Ознакомьтесь с [руководством по формам и валидации](/docs/en/guides/forms-and-validation) или [создайте тикет](https://github.com/mirmanoov/liquid-glass-astro/issues), если у вас возникли проблемы.
</Callout>
