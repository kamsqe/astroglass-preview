...
<Callout type="info" title="在此环节中遇到不顺有些受阻急需呼救指导帮助么？">
  不妨移驾屈尊在内查看过目详细检阅下这份被准备妥当作为专解诸如一些在[撰改表单结构搭建与严守准出检测的表单规范核验处理方面问题向的排除守则与指引说明总集](/docs/zh/guides/forms-and-validation)。若是真不凑巧给碰遇上一些相当让人感觉头疼百思也解决不落不明奇绝古怪阻断你继续往前推行作业不可调解排解等大难题，[那请记得开创一条新反馈直接发往提交上报问题追踪中心去（Issue专区）告知大家前来一起设法援助啦](https://github.com/kamsqe/astroglass/issues)。
</Callout>
